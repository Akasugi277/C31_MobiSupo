...
export default function TabIcon({ focused, color, size, name }: TabIconProps) {
  const { theme } = useContext(ThemeContext);
  const fillColor = focused ? color : (theme === 'light' ? '#121212' : '#fafafa');
  ...
  if (name === 'calendar') {
    return (
      <Svg width={size} height={size} viewBox="0 0 512 512">
        ...
        />
        {/* カレンダーのマス（複数） */}
        <Rect x="183.676" y="377.571" width="56.727" height="56.727" fill={fillColor} />
        <Rect x="183.676" y="289.65" width="56.727" height="56.727" fill={fillColor} />
        <Rect x="95.765" y="377.571" width="56.718" height="56.727" fill={fillColor} />
        <Rect x="95.765" y="289.65" width="56.718" height="56.727" fill={fillColor} />
        <Rect x="359.517" y="201.73" width="56.718" height="56.727" fill={fillColor} />
        <Rect x="271.597" y="201.73" width="56.735" height="56.727" fill={fillColor} />
        <Rect x="271.597" y="289.65" width="56.735" height="56.727" fill={fillColor} />
        <Rect x="359.517" y="377.571" width="56.718" height="56.727" fill={fillColor} />
        <Rect x="359.517" y="289.65" width="56.718" height="56.727" fill={fillColor} />
        <Rect x="271.597" y="377.571" width="56.735" height="56.727" fill={fillColor} />
        <Rect x="183.676" y="201.73" width="56.727" height="56.727" fill={fillColor} />
        <Rect x="95.765" y="201.73" width="56.718" height="56.727" fill={fillColor} />
      </Svg>
    );
  }
